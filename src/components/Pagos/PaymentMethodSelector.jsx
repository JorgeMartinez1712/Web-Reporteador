        ...
        <div className="sm:col-span-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                ...
                ${isSelected ? 'border-emerald-500 bg-emerald-50 shadow-lg' : 'border-gray-300 bg-white hover:border-gray-400'}`}
                        ...
                        >
                            <IconComponent className={`text-xl mr-3 ${isSelected ? 'text-emerald-600' : 'text-gray-500'}`} />
                            <span className={`text-sm font-medium ${isSelected ? 'text-emerald-800' : 'text-gray-700'}`}>{method.name}</span>
                        </div>
                    );
                })}
            </div>
