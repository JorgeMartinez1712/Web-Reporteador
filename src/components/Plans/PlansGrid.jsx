    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-10 w-full">
            ...
            {plans.map((plan) => (
                <div
                    key={plan.id}
                    className="rounded-lg shadow-2xl hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col h-auto min-h-[300px] border-1 border-emerald-300 cursor-pointer"
