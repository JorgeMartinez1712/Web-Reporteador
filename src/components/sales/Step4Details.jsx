    ...
    return (
        <div className="bg-white p-8 rounded-lg max-w-full mx-auto space-y-6">
            ...
            <div>
                ...
                <textarea
                    id="saleNotes"
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-claro focus:border-claro text-gray-800 resize-y"
                    rows="4"
            ...
            <div className="flex justify-between mt-6 pt-6 border-gray-200">
                ...
                <button
                    type="button"
                    onClick={handleNext}
                    className="bg-oscuro text-white px-6 py-2 rounded-lg hover:bg-hover transition duration-300 font-medium"
                >
