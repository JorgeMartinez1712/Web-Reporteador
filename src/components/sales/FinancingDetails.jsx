...
const FinancingDetails = ({ financingContract, totalAmount }) => {
  ...
  return (
    <div className="p-6 rounded-lg border border-emerald-200 col-span-full mt-15">
      <h4 className="text-xl font-bold text-emerald-800 mb-4 border-b border-emerald-200 pb-3 text-left">
        Detalle del Plan de Pago: {planName}
      </h4>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-emerald-700 text-left">
        <div>
