    ...
    return (
        <div className="bg-white p-8 rounded-lg max-w-full space-y-6">
            ...
            <div className="mt-6 pt-6 border-gray-200">
                {isVerifying ? (
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 text-hover text-center flex items-center justify-center">
                ...
                <div>
                    {financingPlan ? (
                        ...
                        <button
                            ...
                            className="border border-oscuro text-oscuro bg-white py-2 px-4 rounded-lg shadow hover:bg-bg transition duration-200 disabled:opacity-50"
