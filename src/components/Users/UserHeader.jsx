        ...
        {!isEditing ? (
          ...
          <>
            ...
            <button
              type="submit"
              onClick={onSaveClick}
              className={`bg-oscuro text-white py-2 px-4 rounded-lg shadow hover:bg-hover transition duration-200 flex items-center justify-center ${isSaveDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
