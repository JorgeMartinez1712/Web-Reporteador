          ...
          <div className="flex flex-col">
            ...
            <div className="flex mt-1">
              <select
                ...
                onChange={handleNameChange}
                className="border border-gray-300 rounded-l-md shadow-sm p-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
                required
                disabled={!isEditing}
              >
                <option value="">--</option>
              ...
              <input
                ...
                onChange={handleNameChange}
                className="flex-1 border border-gray-300 rounded-r-md shadow-sm p-2 sm:text-sm focus:ring-emerald-500 focus:border-emerald-500"
