...
const RegisterCustomerForm = ({ onCustomerCreated, onCancel }) => {
  const { registerCustomerOnly, loading, customerTypes, documentTypes } = useCustomers({ autoFetchLookups: true, fetchStatuses: false });
  ...
  const [_selectedDocTypeCode, setSelectedDocTypeCode] = useState('');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (createdCustomerResponse && onCustomerCreated) {
        onCustomerCreated('Cliente registrado exitosamente.');
      }
